				...
				<c:choose>
							...
							<c:forEach var="item" items="${searchProduct}">
								<c:choose>
									<c:when test="${cate.categoryID eq item.categoryID}">
										...
										<div class="col-12 col-md-6 col-lg-4">
											<div class="card">
											<c:url value="/image?fname=${item.imageLink}" var="imgUrlForSearch"></c:url>
												<img class="card-img-top" src="${imgUrlForSearch}"
													alt="Card image cap" />
												<div class="card-body">
													<h4 class="card-title">
														<a
					...
					<c:otherwise>
						<c:forEach var="item" items="${listAllProduct}">
							<div class="col-12 col-md-6 col-lg-4">
								<div class="card">
								<c:url value="/image?fname=${item.imageLink}" var="imgU"></c:url>
									<img class="card-img-top" src="${imgU}"
										alt="Card image cap" />
									<div class="card-body">
										<h4 class="card-title">
											<a
