				...
				<c:when test="${not empty bestSellerProduct}">
					<div class="card">
						...
						<img class="img-fluid border-0"
							<c:url value="/image?fname=${bestSellerProduct.imageLink}" var="imgForBest"></c:url>
							src="${imgForBest}" alt="Card image cap" />
						<div class="card-body">
				...
				<div class="card-body">
					<div class="row">
						...
						<c:forEach var="item" items="${list4TopProduct}">
							<div class="col-sm">
								<div class="card">
									<c:url value="/image?fname=${item.imageLink}" var="imgForLast"></c:url>
									<img class="card-img-top" src="${imgForLast}"
				...
				<div class="card-body">
					<div class="row">
						...
						<c:forEach var="item" items="${listBestProduct}">
							...
							<div class="col-sm">
								<div class="card">
								<c:url value="/image?fname=${item.imageLink}" var="imgForB"></c:url>
									<img class="card-img-top" src="${imgForB}"
										alt="Card image cap" />
									<div class="card-body">
										<h4 class="card-title">
											<a
										...
										<div class="row">
											...
											<form name="f" action="<c:url value="/cart?idforcart=${item.productID}" />" method="post">
												<div class="col">
												<input  class="btn btn-success btn-block" type="submit" value="Add to cart">
													<!-- <a href="" class="btn btn-success btn-block">Add to cart</a> -->
													<!--  <input  class="btn btn-success btn-block" type="submit" onclick="buy('${item.productID}')" value="Add to cart">-->
												</div>
											</form>
