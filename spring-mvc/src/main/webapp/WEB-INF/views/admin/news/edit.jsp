						...
						<form:form class="form-horizontal" role="form" id="formSubmit"
							...
							<div class="form-group">
								<label for="shortDescription"
									...
									ngắn:</label>
								<div class="col-sm-9">
									<%-- <textarea  rows="5" cols="10" class="form-control" id="shortDescription" name="shortDescription">
							...
							<div class="form-group">
								<label for="content"
									...
									dung:</label>
								<div class="col-sm-9">
									<%-- <textarea  rows="5" cols="10" class="form-control" id="content" name="content">
						  			${model.content}
						  		</textarea> --%>
