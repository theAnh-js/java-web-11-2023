...
<head>
	<decorator:head/>
	<meta charset="utf-8">
	<title><decorator:title default="Diamon Shop" /></title>
...
-->
			...
			<div class="container">
				<div class="alignR">
					...
					<a class="active" href="<c:url value='/'/>"> <span class="icon-home"></span>
						...
						Contact us</a> <a href="<c:url value="/gio-hang/chi-tiet-gio-hang"/>"><span
						class="icon-shopping-cart"></span> ${sessionScope.size} sản phẩm <span
						class="badge badge-warning"> 
						<fmt:formatNumber type="number" groupingUsed="true" value="${sessionScope.totalPriceCart}" />
						₫</span></a>
				</div>
			</div>
		</div>
	...
	<div class="copyright">
		<div class="container">
			<p class="pull-right">
				<a href="#"><img src="<c:url value='/assets/user/img/maestro.png'/>"
					alt="payment"></a> <a href="#"><img
					src="<c:url value='/assets/user/img/mc.png'/>" alt="payment"></a> <a href="#"><img
					src="<c:url value='/assets/user/img/pp.png'/>" alt="payment"></a> <a href="#"><img
					src="<c:url value='/assets/user/img/visa.png'/>" alt="payment"></a> <a href="#"><img
